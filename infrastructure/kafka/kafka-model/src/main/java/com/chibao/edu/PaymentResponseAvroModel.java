...
public class PaymentResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private com.chibao.edu.PaymentStatus paymentStatus;
   ...
   */
  public PaymentResponseAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID paymentId, java.util.UUID customerId, java.util.UUID orderId, java.math.BigDecimal price, java.time.Instant createdAt, com.chibao.edu.PaymentStatus paymentStatus, java.util.List<java.lang.String> failureMessages) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 7: paymentStatus = (com.chibao.edu.PaymentStatus)value$; break;
   ...
   */
  public com.chibao.edu.PaymentStatus getPaymentStatus() {
   ...
   * @param value the value to set.
   */
  public void setPaymentStatus(com.chibao.edu.PaymentStatus value) {
   ...
   */
  public static com.chibao.edu.PaymentResponseAvroModel.Builder newBuilder() {
    return new com.chibao.edu.PaymentResponseAvroModel.Builder();
  }
   ...
   * @return A new PaymentResponseAvroModel RecordBuilder
   */
  public static com.chibao.edu.PaymentResponseAvroModel.Builder newBuilder(com.chibao.edu.PaymentResponseAvroModel.Builder other) {
    if (other == null) {
      return new com.chibao.edu.PaymentResponseAvroModel.Builder();
    } else {
      return new com.chibao.edu.PaymentResponseAvroModel.Builder(other);
    }
  }
   ...
   * @return A new PaymentResponseAvroModel RecordBuilder
   */
  public static com.chibao.edu.PaymentResponseAvroModel.Builder newBuilder(com.chibao.edu.PaymentResponseAvroModel other) {
    if (other == null) {
      return new com.chibao.edu.PaymentResponseAvroModel.Builder();
    } else {
      return new com.chibao.edu.PaymentResponseAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.chibao.edu.PaymentResponseAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.chibao.edu.PaymentResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder setPaymentId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder clearPaymentId() {
      paymentId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder setCustomerId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder setPaymentStatus(com.chibao.edu.PaymentStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder clearPaymentStatus() {
      paymentStatus = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder setFailureMessages(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.PaymentResponseAvroModel.Builder clearFailureMessages() {
    ...
    public PaymentResponseAvroModel build() {
      try {
        ...
        record.paymentStatus = fieldSetFlags()[7] ? this.paymentStatus : (com.chibao.edu.PaymentStatus) defaultValue(fields()[7]);
