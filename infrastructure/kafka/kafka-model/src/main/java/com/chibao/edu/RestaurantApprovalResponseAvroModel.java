...
public class RestaurantApprovalResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 901121524498238189L;
  ...
  private com.chibao.edu.OrderApprovalStatus orderApprovalStatus;
   ...
   */
  public RestaurantApprovalResponseAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID restaurantId, java.util.UUID orderId, java.time.Instant createdAt, com.chibao.edu.OrderApprovalStatus orderApprovalStatus, java.util.List<java.lang.String> failureMessages) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: orderApprovalStatus = (com.chibao.edu.OrderApprovalStatus)value$; break;
   ...
   */
  public com.chibao.edu.OrderApprovalStatus getOrderApprovalStatus() {
   ...
   * @param value the value to set.
   */
  public void setOrderApprovalStatus(com.chibao.edu.OrderApprovalStatus value) {
   ...
   */
  public static com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder newBuilder() {
    return new com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder();
  }
   ...
   * @return A new RestaurantApprovalResponseAvroModel RecordBuilder
   */
  public static com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder newBuilder(com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder other) {
    if (other == null) {
      return new com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder();
    } else {
      return new com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder(other);
    }
  }
   ...
   * @return A new RestaurantApprovalResponseAvroModel RecordBuilder
   */
  public static com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder newBuilder(com.chibao.edu.RestaurantApprovalResponseAvroModel other) {
    if (other == null) {
      return new com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder();
    } else {
      return new com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.chibao.edu.RestaurantApprovalResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder setRestaurantId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder clearRestaurantId() {
      restaurantId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder setOrderApprovalStatus(com.chibao.edu.OrderApprovalStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder clearOrderApprovalStatus() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder setFailureMessages(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.chibao.edu.RestaurantApprovalResponseAvroModel.Builder clearFailureMessages() {
    ...
    public RestaurantApprovalResponseAvroModel build() {
      try {
        ...
        record.orderApprovalStatus = fieldSetFlags()[5] ? this.orderApprovalStatus : (com.chibao.edu.OrderApprovalStatus) defaultValue(fields()[5]);
